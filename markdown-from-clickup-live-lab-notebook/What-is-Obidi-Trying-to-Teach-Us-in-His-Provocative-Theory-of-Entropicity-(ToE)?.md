...
In standard quantum physics, certain events like wave-function collapse or quantum entanglement measurements are often treated as instantaneous. Obidi’s No-Rush Theorem declares that nature cannot be rushed: absolutely every physical interaction requires a finite, non-zero interval of time. 
...
Ultimately, the theory is an attempt at "Ontodynamics"—the study of existence as entropic motion. It seeks to resolve the century-old rift between General Relativity (the physics of the very large) and Quantum Mechanics (the physics of the very small). 
